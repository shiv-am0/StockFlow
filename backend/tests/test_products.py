...
def test_list_products(client):
    client.post("/api/v1/products", json={
        "product_name": "P1",         "sku": "P1SKU", "price": 10, "quantity_in_stock": 5,
    })
    client.post("/api/v1/products", json={
        "product_name": "P2", "sku": "P2SKU", "price": 20, "quantity_in_stock": 15,
    })
...
def test_list_products_with_search(client):
    client.post("/api/v1/products", json={
        "product_name": "Wireless Mouse",         "sku": "WM001", "price": 29.99, "quantity_in_stock": 10,
    })
    client.post("/api/v1/products", json={
        "product_name": "Keyboard", "sku": "KB001", "price": 49.99, "quantity_in_stock": 20,
    })
...
def test_update_product(client):
    create_resp = client.post("/api/v1/products", json={
        "product_name": "Original",         "sku": "SKUORIG", "price": 10, "quantity_in_stock": 5,
    })
    pid = create_resp.json()["id"]
...
def test_delete_product(client):
    create_resp = client.post("/api/v1/products", json={
        "product_name": "To Delete",         "sku": "SKUDEL", "price": 5, "quantity_in_stock": 1,
    })
    pid = create_resp.json()["id"]
...
def test_low_stock_products(client):
    client.post("/api/v1/products", json={
        "product_name": "Low Stock",         "sku": "SKULOW", "price": 5, "quantity_in_stock": 3,
    })
